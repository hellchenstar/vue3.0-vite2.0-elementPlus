...
const iconfontSvgUrl = "https://at.alicdn.com/t/c/font_2605852_cmafimm6hot.js";
const iconfontClassUrl = "https://at.alicdn.com/t/c/font_2605852_cmafimm6hot.css";
...
const config = (option) => {
  return util.deepMerge(configOption, option, {
    excludeKeys(key) {
