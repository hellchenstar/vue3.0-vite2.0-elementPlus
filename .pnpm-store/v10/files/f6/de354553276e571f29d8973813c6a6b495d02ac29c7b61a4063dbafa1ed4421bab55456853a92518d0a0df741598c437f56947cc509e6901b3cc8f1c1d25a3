...
export type VirtualizedPropsPublic = ExtractPublicPropTypes<typeof virtualizedProps>;
export type VirtualizedListProps = ExtractPropTypes<typeof virtualizedListProps>;
export type VirtualizedListPropsPublic = ExtractPublicPropTypes<typeof virtualizedListProps>;
export type VirtualizedGridProps = ExtractPropTypes<typeof virtualizedGridProps>;
export type VirtualizedGridPropsPublic = ExtractPublicPropTypes<typeof virtualizedGridProps>;
export type VirtualizedScrollbarProps = ExtractPropTypes<typeof virtualizedScrollbarProps>;
export type VirtualizedScrollbarPropsPublic = ExtractPublicPropTypes<typeof virtualizedScrollbarProps>;
