import { defineComponent, h, getCurrentInstance, inject, ref, reactive, watch, onBeforeUnmount, onMounted, nextTick } from 'vue';
import { ElCheckbox } from '../../../checkbox/index.mjs';
import { useLocale } from '../../../../hooks/use-locale/index.mjs';
import FilterPanel from '../filter-panel.vue.mjs';
