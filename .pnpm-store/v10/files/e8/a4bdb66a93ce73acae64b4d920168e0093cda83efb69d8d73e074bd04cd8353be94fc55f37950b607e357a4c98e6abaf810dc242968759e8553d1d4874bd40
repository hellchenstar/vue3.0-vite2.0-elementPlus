...
declare const __VLS_base: import("vue").DefineComponent<__VLS_WithDefaultsLocal<__VLS_TypePropsToOption<CollapseProps>, {
    modelValue: () => never[];
...
}, string, import("vue").PublicProps, Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaultsLocal<__VLS_TypePropsToOption<CollapseProps>, {
    modelValue: () => never[];
    expandIconPosition: string;
}>>> & {
    ...
    modelValue: import("./collapse").CollapseModelValue;
    expandIconPosition: import("./collapse").CollapseIconPositionType;
}, {}>;
