...
var tooltip_vue_vue_type_script_setup_true_lang = require('./src/tooltip.vue2.js');
...
const ElTooltip = install.withInstall(tooltip_vue_vue_type_script_setup_true_lang.default);
...
exports.useTooltipTriggerPropsDefaults = trigger.useTooltipTriggerPropsDefaults;
exports.useTooltipContentProps = content.useTooltipContentProps;
exports.useTooltipContentPropsDefaults = content.useTooltipContentPropsDefaults;
