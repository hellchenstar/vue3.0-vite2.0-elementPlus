import type { CSSProperties, ExtractPropTypes, ExtractPublicPropTypes, StyleValue, VNode, VNodeChild } from 'vue';
...
export declare const spaceProps: {
    ...
    readonly style: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => string | false | CSSProperties | StyleValue[]) | (() => StyleValue) | ((new (...args: any[]) => string | false | CSSProperties | StyleValue[]) | (() => StyleValue))[], unknown, unknown, "", boolean>;
    readonly alignment: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => string) | (() => import("csstype").Property.AlignItems | undefined) | ((new (...args: any[]) => string) | (() => import("csstype").Property.AlignItems | undefined))[], unknown, unknown, "center", boolean>;
    readonly prefixCls: {
...
declare const Space: import("vue").DefineComponent<{
    ...
    readonly alignment: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => string) | (() => import("csstype").Property.AlignItems | undefined) | ((new (...args: any[]) => string) | (() => import("csstype").Property.AlignItems | undefined))[], unknown, unknown>;
