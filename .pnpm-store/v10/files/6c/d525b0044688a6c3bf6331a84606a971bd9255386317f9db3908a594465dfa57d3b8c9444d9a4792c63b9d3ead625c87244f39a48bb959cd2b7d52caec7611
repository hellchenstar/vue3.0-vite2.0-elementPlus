...
var scrollbar_vue_vue_type_script_setup_true_lang = require('./src/scrollbar.vue2.js');
...
const ElScrollbar = install.withInstall(scrollbar_vue_vue_type_script_setup_true_lang.default);
