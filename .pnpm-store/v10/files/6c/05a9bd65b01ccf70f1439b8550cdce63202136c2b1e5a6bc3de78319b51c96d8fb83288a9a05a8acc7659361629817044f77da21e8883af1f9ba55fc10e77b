...
export type DisabledTimeListsPropsPublic = ExtractPublicPropTypes<typeof disabledTimeListsProps>;
...
export type TimePanelSharedPropsPublic = ExtractPublicPropTypes<typeof timePanelSharedProps>;
